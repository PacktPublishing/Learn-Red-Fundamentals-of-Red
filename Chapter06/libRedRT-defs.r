[[
        ...
        ** [op! 2 [{Returns a number raised to a given power (exponent)} number [number!] "Base value" exponent [integer! float!] "The power (index) to raise the base value by" return: [number!]] #[none]] 
        ...
        ctx344~get-screen-size [routine! 1 [
                id #[block![2 2235x1 integer!]3] 
                /local 
                pair #[block![2 2235x1 red-pair!]3]
            ] #[none]] 
        ctx344~size-text [routine! 2 [
                face #[block![2 2235x1 red-object!]3] 
                value #[block![2 2235x1 red/cell!]3] 
                /local 
                values #[block![2 2235x1 red/cell!]3] 
                text #[block![2 2235x1 red-string!]3] 
                pair #[block![2 2235x1 red-pair!]3] 
                font #[block![2 2235x1 red-object!]3] 
                state #[block![2 2235x1 red-block!]3] 
                hFont #[block![2 2235x1 pointer! #[block![2 2235x1 integer!]3]]3]
            ] #[none]] 
        ctx344~on-change-facet [routine! 7 [
                owner #[block![2 2235x1 red-object!]3] 
                word #[block![2 2235x1 red-word!]3] 
                value #[block![2 2235x1 red/cell!]3] 
                action #[block![2 2235x1 red-word!]3] 
                new #[block![2 2235x1 red/cell!]3] 
                index #[block![2 2235x1 integer!]3] 
                part #[block![2 2235x1 integer!]3]
            ] #[none]] 
        ctx344~update-font [routine! 2 [font #[block![2 2235x1 red-object!]3] flags #[block![2 2235x1 integer!]3]] #[none]] 
        ctx344~update-para [routine! 2 [face #[block![2 2235x1 red-object!]3] flags #[block![2 2235x1 integer!]3]] #[none]] 
        ctx344~destroy-view [routine! 2 [face #[block![2 2235x1 red-object!]3] empty? #[block![2 2235x1 logic!]3]] #[none]] 
        ctx344~update-view [routine! 1 [face #[block![2 2235x1 red-object!]3]] #[none]] 
        ctx344~refresh-window [routine! 1 [h #[block![2 2235x1 red-handle!]3]] #[none]] 
        ctx344~redraw [routine! 1 [face #[block![2 2235x1 red-object!]3] /local h #[block![2 2235x1 integer!]3]] #[none]] 
        ctx344~show-window [routine! 1 [id #[block![2 2235x1 red-handle!]3]] #[none]] 
        ctx344~make-view [routine! 2 [face #[block![2 2235x1 red-object!]3] parent #[block![2 2235x1 red-handle!]3]] #[none]] 
        ctx344~draw-image [routine! 2 [image #[block![2 2235x1 red-image!]3] cmds #[block![2 2235x1 red-block!]3]] #[none]] 
        ctx344~draw-face [routine! 2 [face #[block![2 2235x1 red-object!]3] cmds #[block![2 2235x1 red-block!]3] /local int #[block![2 2235x1 red-integer!]3]] #[none]] 
        ctx344~do-event-loop [routine! 1 [no-wait? #[block![2 2235x1 logic!]3] /local bool #[block![2 2235x1 red-logic!]3]] #[none]] 
        ctx344~request-font [routine! 3 [font #[block![2 2235x1 red-object!]3] selected #[block![2 2235x1 red-object!]3] mono? #[block![2 2235x1 logic!]3]] #[none]] 
        ctx344~request-file [routine! 5 [
                title #[block![2 2235x1 red-string!]3] 
                name #[block![2 2235x1 red-file!]3] 
                filter #[block![2 2235x1 red-block!]3] 
                save? #[block![2 2235x1 logic!]3] 
                multi? #[block![2 2235x1 logic!]3]
            ] #[none]] 
        ctx344~request-dir [routine! 5 [
                title #[block![2 2235x1 red-string!]3] 
                dir #[block![2 2235x1 red-file!]3] 
                filter #[block![2 2235x1 red-block!]3] 
                keep? #[block![2 2235x1 logic!]3] 
                multi? #[block![2 2235x1 logic!]3]
            ] #[none]] 
        ctx344~text-box-layout [routine! 1 [
                box #[block![2 2235x1 red-object!]3]
            ] #[none]] 
        ctx344~text-box-metrics [routine! 3 [
                state #[block![2 2235x1 red-block!]3] 
                arg0 #[block![2 2235x1 red/cell!]3] 
                type #[block![2 2235x1 integer!]3]
            ] #[none]] 
        ctx344~update-scroller [routine! 2 [scroller #[block![2 2235x1 red-object!]3] flags #[block![2 2235x1 integer!]3]] #[none]] 
        ...
        ctx352~color-backgrounds [function! 1 [
                {Color the background of faces with no color, with parent's background color} 
                root [object!]
            ] #[none]] 
        ctx352~color-tabpanel-children [function! 1 [
                {Color the background of faces with no color, with parent's background color} 
                root [object!] 
                /local gp
            ] #[none]] 
        ctx352~OK-Cancel [function! 1 [
        ...
        opts #[object! [
        ...
        ] ctx357 [root local actions list name] ctx358 [spec] ctx359 [local f blk later? ctx face] ctx360 [face local data min-sz txt len mark s e new] ctx361 [pane dir align max-sz local edge? top-left? axis svmm face offset mar type] ctx362 [tab local tp-size pad pane] ctx363 [code local rule pos color] ctx364 [value local color] ctx365 [opts spec local field value] ctx366 [obj facet field flag local blk] ctx367 [blk local value] ctx368 [expected pos local spec type value] ctx369 [code] ctx370 [
        ...
        ] ctx371 [obj name body spec] ctx372 [
            spec 
            tight 
            options 
            user-opts 
            ...
            win
        ] ctx374 [code local result] ctx375 [face event type local result 
            act name
        ] ctx376 [
            face 
            with 
            ...
            post 
            sub post? local exec
        ] ctx404 [v only] ctx426 [face] ctx429 [
        ...
        ctx354: get-root-node2 1027 
        ctx355: get-root-node2 1030 
        ctx356: get-root-node2 1033 
        ctx357: get-root-node2 1039 
        ctx358: get-root-node2 1044 
        ctx359: get-root-node2 1047 
        ctx360: get-root-node2 1050 
        ctx361: get-root-node2 1053 
        ctx362: get-root-node2 1056 
        ctx363: get-root-node2 1059 
        ctx364: get-root-node2 1062 
        ctx365: get-root-node2 1065 
        ctx366: get-root-node2 1068 
        ctx367: get-root-node2 1071 
        ctx368: get-root-node2 1074 
        ctx369: get-root-node2 1077 
        ctx370: get-root-node2 1080 
        ctx371: get-root-node2 1083 
        ctx372: get-root-node2 1086 
        ctx373: get-root-node2 1089 
        ctx374: get-root-node2 1092 
        ctx375: get-root-node2 1095 
        ctx376: get-root-node2 1098 
        ctx377: get-root-node2 1101 
        ctx378: get-root-node2 1104 
        ctx379: get-root-node2 1107 
        ctx380: get-root-node2 1110 
        ctx381: get-root-node2 1113 
        ctx382: get-root-node2 1116 
        ctx383: get-root-node2 1119 
        ctx384: get-root-node2 1122 
        ctx385: get-root-node2 1125 
        ctx386: get-root-node2 1128 
        ctx387: get-root-node2 1131 
        ctx388: get-root-node2 1134 
        ctx404: get-root-node2 1197 
        ctx426: get-root-node2 1394 
        ctx429: get-root-node2 1422
    ] 432 [%modules/view/view.red]]